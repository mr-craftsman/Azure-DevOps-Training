...
insert into Players(first_name, last_name, country) values ('john', 'doe','USA')

insert into Players(first_name, last_name, country) values ('richard', 'doe','USA')

select * from Players where first_name = 'john'

delete from Players where first_name = 'john'

drop table Players

INSERT INTO Players (id, coach_id, first_name, last_name, country, date_of_birth, p_heigth, p_weight)
VALUES
